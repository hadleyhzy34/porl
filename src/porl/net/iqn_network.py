...
if __name__ == '__main__':
    ...
    # Create network
    iqn_net = IQNNetwork(state_dim, action_dim, embedding_dim, num_quantiles_output, dueling=True)
    ...
    iqn_net_no_dueling = IQNNetwork(state_dim, action_dim, embedding_dim, num_quantiles_output, dueling=False)
